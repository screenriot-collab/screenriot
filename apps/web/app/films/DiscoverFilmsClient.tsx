...
import { usePublicFilmsList, type PublicFilmCardView } from '@/hooks/usePublicFilmsList';
import { FilmCard } from '@/components/films/FilmCard';

const PAGINATION_BUTTON_CLASS =
  'rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white disabled:opacity-50 hover:bg-white/10';

interface DiscoverFilmsClientProps {
...
export function DiscoverFilmsClient({
  initialFilms,
  initialTotal,
  initialPage,
  initialGenre,
  initialSearch,
}: DiscoverFilmsClientProps) {
  const {
    films,
    total,
    loading,
  ...
  return (
    <>
      ...
      <div className="mt-8 flex items-baseline justify-between gap-4">
        <h2 className="text-xl font-semibold text-white">All Film Projects</h2>
