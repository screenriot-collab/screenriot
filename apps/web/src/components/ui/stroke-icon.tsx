...
/** Icons that use stroke="currentColor" — render inline, not as &lt;img&gt;. */
const ICON_PATHS = {
  search: (
  ...
  plus: (
    <>
      <path d="M13 7h8m0 0v8m0-8v-3m-3 3V4m0 0h3m-3 0H4" />
    </>
  ),
  clapperboard: (
    <>
...
export function StrokeIcon({ name, className = 'h-6 w-6' }: StrokeIconProps) {
  return (
    <svg
