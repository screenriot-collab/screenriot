import type { VotingCategory } from '@/markup/film-detail';

function IconStory() {
  return (
    <svg className="h-4 w-4 text-screenriot-accent-blue" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden>
...
export function VotingCategoryIcon({ icon }: { icon: VotingCategory['icon'] }) {
