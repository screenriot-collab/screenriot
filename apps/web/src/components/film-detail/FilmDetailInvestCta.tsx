  ...
  if (!expanded) {
    return (
      <button
        ...
        className="flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-teal-500 to-cyan-500 py-3 text-sm font-semibold text-white transition-opacity hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-screenriot-bg disabled:opacity-50"
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <input
        ...
        className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder:text-gray-500 focus:border-teal-400 focus:outline-none focus:ring-1 focus:ring-teal-400"
        aria-describedby="invest-amount-hint"
        disabled={loading}
      />
      <p id="invest-amount-hint" className="text-xs text-gray-500">
        Minimum $100. You will be redirected to secure checkout.
      </p>
      {error && (
      ...
      <div className="flex gap-2">
        <button
          type="submit"
          disabled={loading}
          className="flex-1 rounded-lg bg-gradient-to-r from-teal-500 to-cyan-500 py-2.5 text-sm font-medium text-white transition-opacity hover:opacity-95 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-screenriot-bg"
        >
        ...
        <button
          ...
          className="rounded-lg border border-white/20 px-3 py-2.5 text-sm font-medium text-gray-300 hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-screenriot-bg"
          aria-label="Cancel"
        >
          Cancel
        </button>
